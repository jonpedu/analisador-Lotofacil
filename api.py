...
def _parse_api_draw(payload: dict[str, Any], concurso_fallback: int) -> dict[str, Any] | None:
...
def fetch_draw_by_concurso(base_url: str, concurso: int, timeout: int = 15) -> dict[str, Any] | None:
    ...
    # Algumas APIs retornam uma lista com um unico item.
    ...
    return _parse_api_draw(item, concurso)
